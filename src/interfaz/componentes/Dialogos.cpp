...
void acercaDe() {
    ...
    if (ImGui::BeginPopupModal("Acerca de", nullptr, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoMove)) {
        ...
        ImGui::SetCursorPosX((ImGui::GetContentRegionAvail().x - ImGui::CalcTextSize("graph-core v3.3").x) * 0.5f);
        ImGui::TextColored(ImVec4(0.6f, 0.6f, 0.7f, 1.0f), "graph-core v3.3");
