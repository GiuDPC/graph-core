...
void ColorFractal::mapearMandelbrot(const Grafo& g,
...
int ColorFractal::iterarMandelbrot(double cx, double cy, int max_iter) {
...
ResultadoColorFractal ColorFractal::calcular(const Grafo& g,
...
uint32_t ColorFractal::colorFusionado(int color_idx, float mod_fractal,
